...
function slide01() {
  ...
  slide.addText("The infrastructure, the market, and the risks", {
...
function slide02() {
  ...
  const items = [
    { num: "01", label: "The Landscape", desc: "Why AI matters, the stack, the supply chain, power", color: C.orange },
    { num: "02", label: "The Market", desc: "Capex, semiconductors, memory, AI labs", color: C.gold },
    { num: "03", label: "The Shifts", desc: "Agentic AI, hardware vs. software divergence", color: C.green },
    { num: "04", label: "The Risks", desc: "Bubble question, supply chain, policy, politics", color: C.red },
    { num: "05", label: "The Frontier", desc: "Space compute, humanoids, autonomous vehicles, healthcare", color: C.teal },
  ];
  ...
  items.forEach((item, i) => {
    ...
    slide.addText(item.num, {
      x: 0.8, y: y, w: 0.6, h: 0.55,
      fontSize: 22, color: item.color, bold: true, fontFace: FONT_HEAD, valign: "middle", margin: 0,
    });
    slide.addText(item.label, {
      x: 1.5, y: y, w: 3.0, h: 0.3,
      fontSize: 18, color: C.black, bold: true, fontFace: FONT_BODY, valign: "bottom", margin: 0,
    });
    slide.addText(item.desc, {
      x: 1.5, y: y + 0.28, w: 7.5, h: 0.27,
      fontSize: 10.5, color: C.medGray, fontFace: FONT_BODY, valign: "top", margin: 0,
    });
  });
...
function slide03() {
  ...
  addSource(slide, "Sources: Company earnings guidance (Q4 2025/Q1 2026), Bloomberg, S&P Global Market Intelligence. Data updated via web search, March 2026.");
  addFooter(slide, 3);
}
...
function slide05() {
  ...
  const layers = [
    ...
    { name: "Packaging / OSAT", companies: "ASE, Amkor, TSMC (in-house CoWoS)", color: C.green },
...
function slide06() {
  ...
  const regions = [
    ...
    { name: "Middle East (Qatar)", role: "Critical Gas Supplier", detail: "~1/3 of global helium supply", risk: "Hormuz/Iran risk", color: C.red },
  ];
...
function slide08() {
  ...
  addSource(slide, "Sources: Company earnings calls, Bloomberg estimates. Figures updated March 2026.");
  addFooter(slide, 8);
}
...
function slide10() {
  ...
  slide.addText([
    ...
    { text: "DDR5: 50 GB/s  |  HBM3E: 1,200 GB/s  |  HBM4: 2,000+ GB/s", options: { fontSize: 9, color: C.orange, bold: true, fontFace: FONT_BODY, breakLine: true } },
    { text: "Total memory market: ~$190B in 2025. DRAM ASP forecast +20–30% YoY.", options: { fontSize: 8.5, color: C.medGray, fontFace: FONT_BODY } },
  ], {
    x: 5.2, y: 3.55, w: 4.3, h: 0.8, valign: "top", margin: 0,
  });

  addSource(slide, "Sources: TrendForce, company disclosures, industry estimates. Market share approximate and shifting.");
  addFooter(slide, 10);
}
...
function slide11() {
  ...
  addSource(slide, "Sources: PitchBook, press reports, company statements. Valuations as of Q1 2026. Updated via web search.");
  addFooter(slide, 11);
}
...
function slide13() {
  ...
  slide.addText("SOXX (Semiconductor ETF) YTD", {
    x: 0.5, y: 1.95, w: 4.3, h: 0.35,
  ...
  slide.addText("IGV (Software ETF) YTD", {
    x: 5.2, y: 1.95, w: 4.3, h: 0.35,
    fontSize: 11, color: C.white, bold: true, fontFace: FONT_BODY, align: "center", valign: "middle", margin: 0,
  });
  ...
  addSource(slide, "Sources: Bloomberg, as of March 2026. YTD returns. Updated via web search.");
  addFooter(slide, 13);
}
...
function slide14() {
  ...
  const tableRows = [
    ...
    [
      ...
      { text: "NVIDIA: 75% gross margin\nMag-7: 26% avg net margin (2x S&P)", options: { fontSize: 8.5, fontFace: FONT_BODY, align: "center", fill: { color: "F9F9F9" } } },
    ],
    [
  ...
  addSource(slide, "Sources: Bloomberg, Refinitiv, company filings, Morningstar.");
  addFooter(slide, 14);
}
  ...
  const pillars = [
    {
      ...
      detail: "H100/H200/Blackwell banned from China. ASML advanced DUV tools banned. Diffusion rule limits chip exports to 140+ countries.",
      color: C.orange,
    },
    {
      title: "AI Regulation",
...
function slide17() {
  ...
  makeSmallStat(slide, "439K", "Worker shortage in construction", 7.5, 0.15, 2.0, C.red);
...
function slide18() {
  ...
  const concepts = [
    { name: "Starcloud (Lonestar)", detail: "First H100 in space (Nov 2025), first LLM trained in orbit (Dec 2025), 88K-satellite filing", color: C.orange },
